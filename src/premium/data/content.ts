...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    summary:
      "Bespoke software for problems generic products cannot solve — engineered, documented and handed over properly.",
    body: [
...
export const work = [
  ...
  },
  {
    ...
    status: "Built product",
    text: "Mission planning, route design, readiness confirmation and command analytics — the full Plan, Prepare, Operate, Review sequence in a single ground-control console.",
    solution: "skygrid",
...
export const process = [
  ...
  },
  {
    step: "03",
    title: "Build",
    text: "Modular engineering with rigorous testing throughout — not a single unreviewed release at the end.",
  },
  {
    step: "04",
    title: "Deploy",
    ...
    body: [
      {
        ...
        text: "Aerial work becomes genuinely useful when it is repeatable. A mission planned once, with defined waypoints and geofences, can be flown again next week under the same conditions — which is what makes aerial data comparable over time instead of merely interesting once.",
      },
      {
