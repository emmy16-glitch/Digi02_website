          ...
          <div className="contact-reference-layout">
            <form id="contact-form" className="contact-reference-form" noValidate onSubmit={handleSubmit} aria-describedby="contact-form-status">
              ...
              <div className="contact-reference-form__grid">
                ...
                <label className={fieldClass('budget')}><span>Budget range</span><span className="contact-reference-field contact-reference-field--select"><span aria-hidden="true">▥</span><select name="budget" value={String(values.budget)} onChange={handleChange('budget')} onBlur={handleBlur('budget')}><option value="">Select budget range</option><option>Under ₦5m</option><option>₦5m to ₦20m</option><option>₦20m to ₦50m</option><option>₦50m+</option><option>Not sure yet</option></select></span></label>
                <label className={fieldClass('timeline')}><span>Timeline</span><span className="contact-reference-field contact-reference-field--select"><ContactIcon name="calendar" /><select name="timeline" value={String(values.timeline)} onChange={handleChange('timeline')} onBlur={handleBlur('timeline')}><option value="">Select timeline</option><option>Immediately</option><option>1 to 3 months</option><option>3 to 6 months</option><option>6+ months</option><option>Exploring options</option></select></span></label>
              </div>
