    ...
    <figure className="product-evidence">
      ...
      >
        ...
        <button
          ...
          type="button"
        >
          <span aria-hidden="true" className="product-evidence__reveal-arrow product-evidence__reveal-arrow--left">
            ←
          </span>
        </button>
        ...
        <button
          ...
          type="button"
        >
          <span aria-hidden="true" className="product-evidence__reveal-arrow product-evidence__reveal-arrow--right">
            →
          </span>
        </button>
      </div>
      ...
      <div className="product-evidence__touch-controls">
        <button aria-label={`Previous product: ${previousProduct.label}`} onClick={previous} type="button">
          ←
        </button>
        <span>{activeProduct.label}</span>
        <button aria-label={`Next product: ${nextProduct.label}`} onClick={next} type="button">
          →
        </button>
      </div>
    </figure>
